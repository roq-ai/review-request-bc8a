  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Review Request: Empowering Small Businesses to Capture Customer Feedback and Transform It into Growth Opportunities"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1633613286991-611fe299c4be?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXZpZXd8ZW58MHx8fHwxNjk3MDI0NTM5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Review Request: Empowering Small Businesses to Capture Customer Feedback and Transform It into Growth Opportunities`}
            </Text>
            <Box
